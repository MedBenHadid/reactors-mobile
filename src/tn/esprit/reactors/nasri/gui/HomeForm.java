...
import tn.esprit.reactors.nasri.gui.test.InboxForm;
...
public class HomeForm extends BaseForm {
    ...
    public HomeForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        fab.addActionListener(e -> {
            ...
            Button addOfferBtn = new Button("Ajouter une offre d'hébérgement");
            Button addRequestBtn = new Button("Ajouter une demande d'hébérgement");
            Button trans = new Button(" ");
            trans.setUIID("Container");
            addOfferBtn.setUIID("Container");
            addRequestBtn.setUIID("Container");
            Style c1s = addOfferBtn.getAllStyles();
            Style c2s = addRequestBtn.getAllStyles();
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        styleContainer(header);
        header.add(new Label("Section - Refugiées"));
        
        
        Container introText = new Container();
        styleContainer(introText);
        SpanLabel content = new SpanLabel("Si vous êtes actuellement réfugié et que vous cherchez un endroit où séjourner, " +
            "veuillez jeter un coup d'œil à notre vaste collection d'hébergements offerts par la communauté " +
            "Vous pouvez aussi parcourir et choisir le réfugié que vous souhaitez soutenir");
        introText.add(content);
        
        
        addAll(header, introText);
    }// </editor-fold>

//-- DON'T EDIT ABOVE THIS LINE!!!
    
    public void styleContainer(Container c) {
        c.setLayout(BoxLayout.xCenter());
        c.getStyle().setPadding(10, 10, 10, 10);
    }
}
